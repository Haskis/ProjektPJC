...
public:
  ...
  //Constants
  static const float BestDecceleration = 0.1;
  static const float BestSpeed = 2;
  static const float BestAcceleration= 0.005;
  static const float BestHealth = 1000;
  static const float BestTurningSpeed = 10;
};
#endif // CAR_H
